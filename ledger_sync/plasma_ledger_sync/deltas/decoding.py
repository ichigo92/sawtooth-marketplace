...
from plasma_ledger_sync.protobuf.agent_pb2 import AgentContainer
from plasma_ledger_sync.protobuf.asset_pb2 import AssetContainer
from plasma_ledger_sync.protobuf.task_pb2 import TaskContainer
from plasma_ledger_sync.protobuf.order_pb2 import OrderContainer


CONTAINERS = {
    AddressSpace.AGENT: AgentContainer,
    AddressSpace.ASSET: AssetContainer,
    AddressSpace.TASK: TaskContainer,
    AddressSpace.ORDER: OrderContainer
}
